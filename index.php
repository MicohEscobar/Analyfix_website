    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image:url(images/bg_1.jpg);">
        ...
        <div class="container">
          ...
          <div class="col-md-7 ftco-animate">
          	<span class="subheading">Welcome to Analyfix</span>
            <h1 class="mb-4">Your data, your currency</h1>
      ...
      <div class="slider-item" style="background-image:url(images/bg_2.jpg);">
        ...
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate">
          	<span class="subheading">Let your Data talk,Let your Data tell you Tommorow</span>
            ...
            <div class="ftco-footer-widget mb-5">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+265 997 114 322</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">analyfix@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
